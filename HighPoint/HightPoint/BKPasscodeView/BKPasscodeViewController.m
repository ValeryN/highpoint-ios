...
@property (nonatomic, strong) UIView                        *viewShaker;
            ...
            [self.delegate passcodeViewController:self authenticatePasscode:passcode resultHandler:^(BOOL succeed) {
                ...
                if (succeed) {
                    ...
                    [animation setFromValue:[NSValue valueWithCGPoint:
                                             CGPointMake([aInputView.passcodeField center].x - 10.0f, [aInputView.passcodeField center].y)]];
                    [animation setToValue:[NSValue valueWithCGPoint:
                                           CGPointMake([aInputView.passcodeField center].x + 10.0f, [aInputView.passcodeField center].y)]];
                    [[aInputView.passcodeField layer] addAnimation:animation forKey:@"position"];
